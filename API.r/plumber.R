...
#* @param Veggies Eats_Veggies or No_Veggies
...
#* @post /pred
function(Sex=Female,Veggies=Eats_Veggies,AnyHealthcare=Yes_Health_Coverage,GenHlth=Very_Good,PhysActivity=Physical_Activity) {
